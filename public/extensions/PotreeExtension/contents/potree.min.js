...
e);b=new b(a);if(void 0===e||1===e)return b[0];a=[];for(c=0;c<e;c++)a.push(b[c]);return a}function R(a){this.arraybuffer=a}function V(a){var b=this;this.arraybuffer=a;this.nextCB=null;this.dorr=function(a,e){b.nextCB=e;u.workerPool.runTask(y.LAS_LAZ,function(a){null!==b.nextCB&&(b.nextCB(a.data),b.nextCB=null)},a)}}function J(a){this.arraybuffer=a;this.determineVersion();if(12<this.version)throw Error('Only file versions <= 1.2 are supported at this time');this.determineFormat();if(void 0===la[this.formatId])throw Error('The point format ID is not supported');
this.loader=this.isCompressed?new V(this.arraybuffer):new R(this.arraybuffer)}function ea(a,b,c,e,d,f,g,k){this.arrayb=a;this.decoder=la[b];this.pointsCount=e;this.pointSize=c;this.scale=d;this.offset=f;this.mins=g;this.maxs=k}function S(a,b,c,e,d,f,g,k,h){THREE.Texture.call(this,a,b,c,e,d,f,g,k,h);this.needsUpdate=!0}function fa(a){this.content=[];this.scoreFunction=a}function Ja(a,b){a=a.elements;b=b.elements;for(let c=0;16>c;c++)if(a[c]!==b[c])return!1;return!0}function ma(a,b,c){var e=0,d=new Map(a.map(a=>
[a,0])),f=[],g=[],k=Infinity,h=na(a,b),l=h.frustums,m=h.camObjPositions;h=h.priorityQueue;var p=0;c=c.domElement.clientHeight;u.pointcloudTransformVersion||(u.pointcloudTransformVersion=new Map);for(var n=u.pointcloudTransformVersion,q=0;q<a.length;q++){var w=a[q];if(w.visible)if(w.updateMatrixWorld(),n.has(w)){var r=n.get(w);Ja(r.transform,w.matrixWorld)||(r.number++,r.transform.copy(w.matrixWorld),w.dispatchEvent({type:'transformation_changed',target:w}))}else n.set(w,{number:0,transform:w.matrixWorld.clone()})}for(;0<
h.size();){r=h.pop();var v=r.node;q=r.parent;w=a[r.pointcloud];var t=v.getBoundingBox(),x=m[r.pointcloud],G=l[r.pointcloud].intersectsBox(t);t=w.maxLevel||Infinity;var y=v.getLevel();G=(G=G&&!(d.get(w)+v.getNumPoints()>w.pointBudget))&&y<t;v.spacing?k=Math.min(k,v.spacing):v.geometryNode&&v.geometryNode.spacing&&(k=Math.min(k,v.geometryNode.spacing));if(G)for(e+=v.getNumPoints(),t=d.get(w),d.set(w,t+v.getNumPoints()),w.numVisibleNodes++,w.numVisiblePoints+=v.getNumPoints(),!v.isGeometryNode()||q&&
!q.isTreeNode()||(v.isLoaded()&&p<u.maxNodesLoadGPUFrame?(v=w.toTreeNode(v,q),p++):g.push(v)),v.isTreeNode()&&(u.lru.touch(v.geometryNode),v.sceneNode.visible=!0,v.sceneNode.material=w.material,f.push(v),w.visibleNodes.push(v),void 0===v._transformVersion&&(v._transformVersion=-1),q=n.get(w),v._transformVersion!==q.number&&(v.sceneNode.updateMatrix(),v.sceneNode.matrixWorld.multiplyMatrices(w.matrixWorld,v.sceneNode.matrix),v._transformVersion=q.number),w.showBoundingBox&&!v.boundingBoxNode&&v.getBoundingBox?
(q=new THREE.Box3Helper(v.getBoundingBox()),q.matrixAutoUpdate=!1,w.boundingBoxNodes.push(q),v.boundingBoxNode=q,v.boundingBoxNode.matrix.copy(w.matrixWorld)):w.showBoundingBox?(v.boundingBoxNode.visible=!0,v.boundingBoxNode.matrix.copy(w.matrixWorld)):!w.showBoundingBox&&v.boundingBoxNode&&(v.boundingBoxNode.visible=!1)),t=v.getChildren(),q=0;q<t.length;q++){y=t[q];var z=0;if(b.isPerspectiveCamera){var B=y.getBoundingSphere(new THREE.Sphere);G=B.center.distanceTo(x);B=B.radius;z=.5*c/(Math.tan(b.fov*
Math.PI/180/2)*G)*B;if(z<w.minimumNodePixelSize)continue;0>G-B&&(z=Number.MAX_VALUE)}else B=y.getBoundingBox(),G=y.getBoundingSphere(new THREE.Sphere).center.distanceTo(x),z=B.max.clone().sub(B.min).length()/G;h.push({pointcloud:r.pointcloud,node:y,parent:v,weight:z})}}a=a.filter(a=>a.generateDEM&&a.dem instanceof DEM);for(w of a)a=w.visibleNodes.filter(a=>a.getLevel()<=u.maxDEMLevel),w.dem.update(a);for(q=0;q<Math.min(u.maxNodesLoading,g.length);q++)g[q].load();return{visibleNodes:f,numVisiblePoints:e,
lowestSpacing:k}}function oa(a,b,c){for(var e=ma(a,b,c),d=0;d<a.length;d++)a[d].updateMaterial(a[d].material,a[d].visibleNodes,b,c),a[d].updateVisibleBounds();u.lru.freeMemory();return e}function na(a,b,c){c=[];for(var e=[],d=new fa(function(a){return 1/a.weight}),f=0;f<a.length;f++){var g=a[f];if(g.initialized()){g.numVisibleNodes=0;g.numVisiblePoints=0;g.deepestVisibleLevel=0;g.visibleNodes=[];g.visibleGeometry=[];b.updateMatrixWorld();var k=new THREE.Frustum,h=b.matrixWorldInverse,l=g.matrixWorld,
m=b.clone();m.near=b.near;m.updateProjectionMatrix();m=b.projectionMatrix;h=(new THREE.Matrix4).multiply(m).multiply(h).multiply(l);k.setFromMatrix(h);c.push(k);k=b.matrixWorld;l=(new THREE.Matrix4).getInverse(l);l=(new THREE.Matrix4).multiply(l).multiply(k);l=(new THREE.Vector3).setFromMatrixPosition(l);e.push(l);g.visible&&null!==g.root&&d.push({pointcloud:f,node:g.root,weight:Number.MAX_VALUE});g.root.isTreeNode()&&g.hideDescendants(g.root.sceneNode);for(l=0;l<g.boundingBoxNodes.length;l++)g.boundingBoxNodes[l].visible=
...
extensions.get('WEBGL_depth_texture'),null!==c)?c.UNSIGNED_INT_24_8_WEBGL:0}class Ma{constructor(a){this.next=this.previous=null;this.node=a}}class pa{constructor(){this.last=this.first=null;this.items={};this.numPoints=this.elements=0}size(){return this.elements}contains(a){return null==this.items[a.id]}touch(a){if(a.loaded)if(null==this.items[a.id]){var b=new Ma(a);b.previous=this.last;this.last=b;null!==b.previous&&(b.previous.next=b);this.items[a.id]=b;this.elements++;null===this.first&&(this.first=
b);this.numPoints+=a.numPoints}else b=this.items[a.id],null===b.previous?null!==b.next&&(this.first=b.next,this.first.previous=null,b.previous=this.last,b.next=null,this.last=b,b.previous.next=b):null!==b.next&&(b.previous.next=b.next,b.next.previous=b.previous,b.previous=this.last,b.next=null,this.last=b,b.previous.next=b)}remove(a){var b=this.items[a.id];b&&(1===this.elements?this.last=this.first=null:(b.previous||(this.first=b.next,this.first.previous=null),b.next||(this.last=b.previous,this.last.next=
null),b.previous&&b.next&&(b.previous.next=b.next,b.next.previous=b.previous)),delete this.items[a.id],this.elements--,this.numPoints-=a.numPoints)}getLRUItem(){return null===this.first?null:this.first.node}toString(){for(var a='{ ',b=this.first;null!==b;)a+=b.node.id,null!==b.next&&(a+=', '),b=b.next;return a=a+'}'+('('+this.size()+')')}freeMemory(){if(!(1>=this.elements))for(;this.numPoints>u.pointLoadLimit;)this.disposeDescendants(this.first.node)}disposeDescendants(a){var b=[];for(b.push(a);0<
b.length;){a=b.pop();a.dispose();this.remove(a);for(var c in a.children)a.children.hasOwnProperty(c)&&a.children[c].loaded&&b.push(a.children[c])}}}class y{constructor(){this.workers=[];for(var a=0;a<y.URLS.length;a++)this.workers.push([])}getWorker(a){return 0<this.workers[a].length?this.workers[a].pop():new Worker(u.workerPath+y.URLS[a])}returnWorker(a,b){this.workers[a].push(b)}runTask(a,b,c,e){var d=this,f=this.getWorker(a);f.onmessage=function(c){b(c);d.returnWorker(a,f)};void 0!==e?f.postMessage(c,
e):f.postMessage(c)}}y.BINARY_DECODER=0;y.LAS_LAZ=1;y.LAS_DECODER=2;y.GREYHOUND=3;y.DEM=4;y.EPT_LAS_ZIP_DECODER=5;y.EPT_BINARY_DECODER=6;y.URLS='/workers/BinaryDecoderWorker.js /workers/LASLAZWorker.js /workers/LASDecoderWorker.js /workers/GreyhoundBinaryDecoderWorker.js /workers/DEMWorker.js /workers/EptLaszipDecoderWorker.js /workers/EptBinaryDecoderWorker.js'.split(' ');var u={debug:{},workerPath:function(){if(document.currentScript&&document.currentScript.src){var a=(new URL(document.currentScript.src+
'/..')).href;'/'===a.slice(-1)&&(a=a.slice(0,-1));return a}console.error('Potree: Was unable to find its script path using document.currentScript.');return''}(),maxNodesLoadGPUFrame:20,maxDEMLevel:0,maxNodesLoading:void 0!==navigator.hardwareConcurrency?navigator.hardwareConcurrency:4,pointLoadLimit:1E10,numNodesLoading:0,measureTimings:!1,workerPool:new y,lru:new pa,pointcloudTransformVersion:void 0,denormalizeUint8Array:function(a){const b=new Float32Array(a.length);for(let c=0;c<b.length;c++)b[c]=
a[c]/255;return b}},x={POSITION_CARTESIAN:0,COLOR_PACKED:1,COLOR_FLOATS_1:2,COLOR_FLOATS_255:3,NORMAL_FLOATS:4,FILLER:5,INTENSITY:6,CLASSIFICATION:7,NORMAL_SPHEREMAPPED:8,NORMAL_OCT16:9,NORMAL:10,RETURN_NUMBER:11,NUMBER_OF_RETURNS:12,SOURCE_ID:13,INDICES:14,SPACING:15},C={DATA_TYPE_DOUBLE:{ordinal:0,size:8},DATA_TYPE_FLOAT:{ordinal:1,size:4},DATA_TYPE_INT8:{ordinal:2,size:1},DATA_TYPE_UINT8:{ordinal:3,size:1},DATA_TYPE_INT16:{ordinal:4,size:2},DATA_TYPE_UINT16:{ordinal:5,size:2},DATA_TYPE_INT32:{ordinal:6,
size:4},DATA_TYPE_UINT32:{ordinal:7,size:4},DATA_TYPE_INT64:{ordinal:8,size:8},DATA_TYPE_UINT64:{ordinal:9,size:8}},qa=0,ra;for(ra in C)C[qa]=C[ra],qa++;t.POSITION_CARTESIAN=new t(x.POSITION_CARTESIAN,C.DATA_TYPE_FLOAT,3);t.RGBA_PACKED=new t(x.COLOR_PACKED,C.DATA_TYPE_INT8,4);t.COLOR_PACKED=t.RGBA_PACKED;t.RGB_PACKED=new t(x.COLOR_PACKED,C.DATA_TYPE_INT8,3);t.NORMAL_FLOATS=new t(x.NORMAL_FLOATS,C.DATA_TYPE_FLOAT,3);t.FILLER_1B=new t(x.FILLER,C.DATA_TYPE_UINT8,1);t.INTENSITY=new t(x.INTENSITY,C.DATA_TYPE_UINT16,
...
d*(1-f):0;d=isFinite(c)?d*f:0;f=e+p+n+d;e/=f;p/=f;n/=f;d/=f;if(0===f)return null;f=0;isFinite(b)&&(f+=b*e);isFinite(a)&&(f+=a*p);isFinite(m)&&(f+=m*n);isFinite(c)&&(f+=c*d);return f}height(a){for(var b=null,c=0;c<this.mipMap.length&&(b=this.heightAtMipMapLevel(a,c),null===b);c++);return b}traverse(a,b=0){a(this,b);for(var c of this.children.filter(a=>void 0!==a))c.traverse(a,b+1)}}class sa{constructor(a){this.pointcloud=a;this.boundingBox=this.matrix=null;this.tileSize=64;this.root=null;this.version=
...
1),b.data[k+g.tileSize*p]=a[n+g.tileSize*q])}b.createMipMap();b.mipMapNeedsUpdate=!0}},b,[b.position])}}}class W{constructor(){this.needsTransformUpdate=!0}getChildren(){}getBoundingBox(){}isLoaded(){}isGeometryNode(){}isTreeNode(){}getLevel(){}getBoundingSphere(){}}class T extends THREE.Object3D{constructor(){super();this.dem=new sa(this)}initialized(){return null!==this.root}}class ta{constructor(){this.spacing=0;this.nodes=this.root=this.boundingBox=null;this.pointAttributes={};this.hierarchyStepSize=
-1;this.serverURL=this.boundingSphere=this.projection=this.offset=this.baseDepth=this.schema=this.loader=null;this.normalize={color:!1,intensity:!1}}}z.IDCount=0;z.prototype=Object.create(W.prototype);z.prototype.isGeometryNode=function(){return!0};z.prototype.isTreeNode=function(){return!1};z.prototype.isLoaded=function(){return this.loaded};z.prototype.getBoundingSphere=function(){return this.boundingSphere};z.prototype.getBoundingBox=function(){return this.boundingBox};z.prototype.getLevel=function(){return this.level};
...
new E(a);return this.versionMajor>a.versionMajor||this.versionMajor===a.versionMajor&&this.versionMinor>=a.versionMinor?!0:!1};E.prototype.upTo=function(a){return!this.newerThan(a)};class ua{constructor(a,b,c){this.version='string'===typeof a?new E(a):a;this.boundingBox=b;this.scale=c}load(a){if(!a.loaded){var b=this,c=a.getURL(),e=new XMLHttpRequest;e.overrideMimeType('text/plain');e.open('GET',c,!0);e.responseType='arraybuffer';e.overrideMimeType('text/plain; charset=x-user-defined');e.onload=function(){try{b.parse(a,
...
min:[c.min.x,c.min.y,c.min.z],max:[c.max.x,c.max.y,c.max.z],offset:d.toArray(),scale:this.scale,normalize:a.pcoGeometry.normalize};u.workerPool.runTask(y.GREYHOUND,function(b){b=b.data;var c=b.attributeBuffers,d=new THREE.Box3((new THREE.Vector3).fromArray(b.tightBoundingBox.min),(new THREE.Vector3).fromArray(b.tightBoundingBox.max)),e=new THREE.BufferGeometry;e.isPoints=!0;for(var f in c){var m=c[f].buffer;parseInt(f)===x.POSITION_CARTESIAN?e.addAttribute('position',new THREE.BufferAttribute(new Float32Array(m),
3)):parseInt(f)===x.COLOR_PACKED?e.addAttribute('color',new THREE.BufferAttribute(u.denormalizeUint8Array(new Uint8Array(m)),4)):parseInt(f)===x.INTENSITY?e.addAttribute('intensity',new THREE.BufferAttribute(new Float32Array(m),1)):parseInt(f)===x.CLASSIFICATION?e.addAttribute('classification',new THREE.BufferAttribute(new Uint8Array(m),1)):parseInt(f)===x.NORMAL_SPHEREMAPPED?e.addAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(f)===x.NORMAL_OCT16?e.addAttribute('normal',
new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(f)===x.NORMAL?e.addAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(f)===x.INDICES?(m=new THREE.BufferAttribute(new Uint8Array(m),4),m.normalized=!0,e.addAttribute('indices',m)):parseInt(f)===x.SPACING&&(m=new THREE.BufferAttribute(new Float32Array(m),1),e.addAttribute('spacing',m))}d.max.sub(d.min);d.min.set(0,0,0);a.numPoints=b.numPoints;a.geometry=e;a.mean=new THREE.Vector3(...b.mean);a.tightBoundingBox=d;a.loaded=
!0;a.loading=!1;u.numNodesLoading--},b,[b.buffer])}}class H{static getQueryParam(a){a=a.replace(/[[\]]/g,'\\$&');return(a=(new RegExp('[?&]'+a+'(=([^&#]*)|&|#|$)')).exec(window.location.href))?a[2]?decodeURIComponent(a[2].replace(/\+/g,' ')):'':null}static createSchema(a){var b=[{name:'X',size:4,type:'signed'},{name:'Y',size:4,type:'signed'},{name:'Z',size:4,type:'signed'}];a.forEach(function(a){'COLOR_PACKED'===a?(b.push({name:'Red',size:2,type:'unsigned'}),b.push({name:'Green',size:2,type:'unsigned'}),
b.push({name:'Blue',size:2,type:'unsigned'})):'INTENSITY'===a?b.push({name:'Intensity',size:2,type:'unsigned'}):'CLASSIFICATION'===a&&b.push({name:'Classification',size:1,type:'unsigned'})});return b}static fetch(a,b){var c=new XMLHttpRequest;c.overrideMimeType('text/plain');c.open('GET',a,!0);c.onreadystatechange=function(){4===c.readyState&&(200===c.status||0===c.status?b(null,c.responseText):b(c.responseText))};c.send(null)}static fetchBinary(a,b){var c=new XMLHttpRequest;c.overrideMimeType('text/plain');
c.open('GET',a,!0);c.responseType='arraybuffer';c.onreadystatechange=function(){4===c.readyState&&(200===c.status||0===c.status?b(null,c.response):b(c.responseText))};c.send(null)}static pointSizeFrom(a){return a.reduce((a,c)=>a+c.size,0)}static getNormalization(a,b,c){var e=[{name:'X',size:4,type:'floating'},{name:'Y',size:4,type:'floating'},{name:'Z',size:4,type:'floating'},{name:'Red',size:2,type:'unsigned'},{name:'Green',size:2,type:'unsigned'},{name:'Blue',size:2,type:'unsigned'},{name:'Intensity',
size:2,type:'unsigned'}];a=a+'read?depth='+b+'&schema='+JSON.stringify(e);H.fetchBinary(a,function(a,b){if(a)throw Error(a);a=new DataView(b);b=b.byteLength-4;for(var d=H.pointSizeFrom(e),f=!1,h=!1,l=0;l<b;l+=d){if(255<a.getUint16(l+12,!0)||255<a.getUint16(l+14,!0)||255<a.getUint16(l+16,!0))f=!0;255<a.getUint16(l+18,!0)&&(h=!0);if(f&&h)break}c(null,{color:f,intensity:h})})}}N.loadInfoJSON=function(a,b){};N.load=function(a,b){try{var c=a.split('greyhound://')[1];1===c.split('http://').length&&1===
c.split('https://').length&&(c='http://'+c);H.fetch(c+'info',function(a,d){if(a)throw Error(a);a=JSON.parse(d);var e=new E('1.4'),g=a.bounds;d=a.scale||.01;Array.isArray(d)&&(d=Math.min(d[0],d[1],d[2]));H.getQueryParam('scale')&&(d=parseFloat(H.getQueryParam('scale')));var k=Math.max(8,a.baseDepth),h=['POSITION_CARTESIAN'],l=!1,m=!1,p=!1;a.schema.forEach(function(a){'Intensity'===a.name&&h.push('INTENSITY');'Classification'===a.name&&h.push('CLASSIFICATION');'Red'===a.name?l=!0:'Green'===a.name?m=
!0:'Blue'===a.name&&(p=!0)});l&&m&&p&&h.push('COLOR_PACKED');var n=new ta;n.serverURL=c;n.spacing=(g[3]-g[0])/Math.pow(2,k);n.baseDepth=k;n.hierarchyStepSize=5;n.schema=H.createSchema(h);k=H.pointSizeFrom(n.schema);n.pointAttributes=new F(h);n.pointAttributes.byteSize=k;g=new THREE.Box3((new THREE.Vector3).fromArray(g,0),(new THREE.Vector3).fromArray(g,3));k=g.min.clone();g.max.sub(g.min);g.min.set(0,0,0);n.projection=a.srs;n.boundingBox=g;n.boundingSphere=g.getBoundingSphere(new THREE.Sphere);n.scale=
d;n.offset=k;n.loader=new ua(e,g,n.scale);e={};d=new z('r',n,g,d,k);d.level=0;d.hasChildren=!0;d.numPoints=a.numPoints;d.spacing=n.spacing;n.root=d;n.root.load();e.r=d;n.nodes=e;H.getNormalization(c,a.baseDepth,function(a,c){c.color&&(n.normalize.color=!0);c.intensity&&(n.normalize.intensity=!0);b(n)})})}catch(e){console.log('Potree: Loading failed.',a,e),b()}};N.loadPointAttributes=function(a){a=a.pointAttributes;for(var b=new F,c=0;c<a.length;c++)b.add(t[a[c]]);return b};N.createChildAABB=function(a,
b){var c=a.min;a=a.max;var e=(new THREE.Vector3).copy(a).sub(c).multiplyScalar(.5),d=new THREE.Vector3(e.x,0,0),f=new THREE.Vector3(0,e.y,0),g=new THREE.Vector3(0,0,e.z),k=c,h=(new THREE.Vector3).add(c).add(e);1===b?(c=(new THREE.Vector3).copy(k).add(g),a=(new THREE.Vector3).copy(h).add(g)):3===b?(c=(new THREE.Vector3).copy(k).add(g).add(f),a=(new THREE.Vector3).copy(h).add(g).add(f)):0===b?(c=k,a=h):2===b?(c=(new THREE.Vector3).copy(k).add(f),a=(new THREE.Vector3).copy(h).add(f)):5===b?(c=(new THREE.Vector3).copy(k).add(g).add(d),
a=(new THREE.Vector3).copy(h).add(g).add(d)):7===b?(c=(new THREE.Vector3).copy(k).add(e),a=(new THREE.Vector3).copy(h).add(e)):4===b?(c=(new THREE.Vector3).copy(k).add(d),a=(new THREE.Vector3).copy(h).add(d)):6===b&&(c=(new THREE.Vector3).copy(k).add(d).add(f),a=(new THREE.Vector3).copy(h).add(d).add(f));return new THREE.Box3(c,a)};class va{constructor(a,b,c){this.version='string'===typeof a?new E(a):a;this.boundingBox=b;this.scale=c}load(a){if(!a.loaded){var b=a.getURL();this.version.equalOrHigher('1.4')&&
...
(new THREE.Vector3).fromArray(d.tightBoundingBox.max)),h=new THREE.BufferGeometry;h.isPoints=!0;for(var l in e){var m=e[l].buffer;parseInt(l)===x.POSITION_CARTESIAN?h.addAttribute('position',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(l)===x.COLOR_PACKED?h.addAttribute('color',new THREE.BufferAttribute(u.denormalizeUint8Array(new Uint8Array(m)),4)):parseInt(l)===x.INTENSITY?h.addAttribute('intensity',new THREE.BufferAttribute(new Float32Array(m),1)):parseInt(l)===x.CLASSIFICATION?h.addAttribute('classification',
new THREE.BufferAttribute(new Uint8Array(m),1)):parseInt(l)===x.NORMAL_SPHEREMAPPED?h.addAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(l)===x.NORMAL_OCT16?h.addAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(l)===x.NORMAL?h.addAttribute('normal',new THREE.BufferAttribute(new Float32Array(m),3)):parseInt(l)===x.INDICES?(m=new THREE.BufferAttribute(new Uint8Array(m),4),m.normalized=!0,h.addAttribute('indices',m)):parseInt(l)===x.SPACING&&
(m=new THREE.BufferAttribute(new Float32Array(m),1),h.addAttribute('spacing',m))}k.max.sub(k.min);k.min.set(0,0,0);a.numPoints=b.data.buffer.byteLength/c.byteSize;a.geometry=h;a.mean=new THREE.Vector3(...d.mean);a.tightBoundingBox=k;a.loaded=!0;a.loading=!1;a.estimatedSpacing=d.estimatedSpacing;u.numNodesLoading--}},b,[b.buffer])}}var la=[function(a){return{position:[a.getInt32(0,!0),a.getInt32(4,!0),a.getInt32(8,!0)],intensity:a.getUint16(12,!0),classification:a.getUint8(16,!0)}},function(a){return{position:[a.getInt32(0,
!0),a.getInt32(4,!0),a.getInt32(8,!0)],intensity:a.getUint16(12,!0),classification:a.getUint8(16,!0)}},function(a){return{position:[a.getInt32(0,!0),a.getInt32(4,!0),a.getInt32(8,!0)],intensity:a.getUint16(12,!0),classification:a.getUint8(16,!0),color:[a.getUint16(20,!0),a.getUint16(22,!0),a.getUint16(24,!0)]}},function(a){return{position:[a.getInt32(0,!0),a.getInt32(4,!0),a.getInt32(8,!0)],intensity:a.getUint16(12,!0),classification:a.getUint8(16,!0),color:[a.getUint16(28,!0),a.getUint16(30,!0),
a.getUint16(32,!0)]}}];R.prototype.open=function(){this.readOffset=0;return new Promise(function(a,b){setTimeout(a,0)})};R.prototype.getHeader=function(){var a=this;return new Promise(function(b,c){setTimeout(function(){var c=a.arraybuffer,d={};d.pointsOffset=I(c,Uint32Array,96);d.pointsFormatId=I(c,Uint8Array,104);d.pointsStructSize=I(c,Uint16Array,105);d.pointsCount=I(c,Uint32Array,107);var f=131;d.scale=I(c,Float64Array,f,3);f+=24;d.offset=I(c,Float64Array,f,3);c=I(c,Float64Array,f+24,6);d.maxs=
[c[0],c[2],c[4]];d.mins=[c[1],c[3],c[5]];a.header=d;b(a.header)},0)})};R.prototype.readData=function(a,b,c){var e=this;return new Promise(function(b,f){setTimeout(function(){if(!e.header)return f(Error('Cannot start reading data till a header request is issued'));if(1>=c){a=Math.min(a,e.header.pointsCount-e.readOffset);var d=e.header.pointsOffset+e.readOffset*e.header.pointsStructSize;b({buffer:e.arraybuffer.slice(d,d+a*e.header.pointsStructSize),count:a,hasMoreData:e.readOffset+a<e.header.pointsCount});
e.readOffset+=a}else{for(var k=Math.min(a*c,e.header.pointsCount-e.readOffset),h=0,l=new Uint8Array(Math.ceil(k/c)*e.header.pointsStructSize),m=0;m<k;m++)0===m%c&&(d=e.header.pointsOffset+e.readOffset*e.header.pointsStructSize,d=new Uint8Array(e.arraybuffer,d,e.header.pointsStructSize),l.set(d,h*e.header.pointsStructSize),h++),e.readOffset++;b({buffer:l.buffer,count:h,hasMoreData:e.readOffset<e.header.pointsCount})}},0)})};R.prototype.close=function(){var a=this;return new Promise(function(b,c){a.arraybuffer=
null;setTimeout(b,0)})};V.prototype.open=function(){var a=this;return new Promise(function(b,c){a.dorr({type:'open',arraybuffer:a.arraybuffer},function(a){if(1!==a.status)return c(Error('Failed to open file'));b(!0)})})};V.prototype.getHeader=function(){var a=this;return new Promise(function(b,c){a.dorr({type:'header'},function(a){if(1!==a.status)return c(Error('Failed to get header'));b(a.header)})})};V.prototype.readData=function(a,b,c){var e=this;return new Promise(function(d,f){e.dorr({type:'read',
count:a,offset:b,skip:c},function(a){if(1!==a.status)return f(Error('Failed to read data'));d({buffer:a.buffer,count:a.count,hasMoreData:a.hasMoreData})})})};V.prototype.close=function(){var a=this;return new Promise(function(b,c){a.dorr({type:'close'},function(a){if(1!==a.status)return c(Error('Failed to close file'));b(!0)})})};J.prototype.determineFormat=function(){var a=I(this.arraybuffer,Uint8Array,104),b=(a&128)>>7,c=(a&64)>>6;if(1===b&&1===c)throw Error('Old style compression not supported');
this.formatId=a&63;this.isCompressed=1===b||1===c};J.prototype.determineVersion=function(){var a=new Int8Array(this.arraybuffer,24,2);this.version=10*a[0]+a[1];this.versionAsString=a[0]+'.'+a[1]};J.prototype.open=function(){return this.loader.open()};J.prototype.getHeader=function(){return this.loader.getHeader()};J.prototype.readData=function(a,b,c){return this.loader.readData(a,b,c)};J.prototype.close=function(){return this.loader.close()};ea.prototype.getPoint=function(a){if(0>a||a>=this.pointsCount)throw Error('Point index out of range');
return this.decoder(new DataView(this.arrayb,a*this.pointSize,this.pointSize))};class wa{constructor(a){this.version='string'===typeof a?new E(a):a}load(a){if(!a.loaded){var b=a.pcoGeometry.pointAttributes,c=a.getURL();this.version.equalOrHigher('1.4')&&(c+='.'+b.toLowerCase());var e=this,d=new XMLHttpRequest;d.open('GET',c,!0);d.responseType='arraybuffer';d.overrideMimeType('text/plain; charset=x-user-defined');d.onload=function(){if(d.response instanceof ArrayBuffer)try{e.parse(a,d.response)}catch(f){console.error('Potree: Exception thrown parsing points.',
f),u.numNodesLoading--}else u.numNodesLoading--,console.log('Potree: LASLAZLoader xhr response is not a ArrayBuffer.')};d.onerror=function(){u.numNodesLoading--;console.log('Potree: LASLAZLoader failed to load file, '+d.status+', file: '+c)};d.send(null)}}parse(a,b){var c=new J(b),e=new Na(a);c.open().then(a=>{c.isOpen=!0;return c}).catch(a=>{console.log('Potree: Failed to open file.')}).then(a=>a.getHeader().then(function(b){return[a,b]})).then(a=>{let b=a[0],c=a[1],d=0;var h=function(){return b.readData(1E6,
0,1).then(function(a){e.push(new ea(a.buffer,c.pointsFormatId,c.pointsStructSize,a.count,c.scale,c.offset,c.mins,c.maxs));d+=a.count;if(a.hasMoreData)return h();c.totalRead=d;c.versionAsString=b.versionAsString;c.isCompressed=b.isCompressed;return[b,c,e]})};return h()}).then(a=>{let b=a[0];return b.close().then(function(){b.isOpen=!1;return a.slice(1)}).catch(a=>{if(b.isOpen)return b.close().then(function(){b.isOpen=!1;throw a;});throw a;})})}handle(a,b){}}class Na{constructor(a){this.node=a}push(a){var b=
this,c={buffer:a.arrayb,numPoints:a.pointsCount,pointSize:a.pointSize,pointFormatID:2,scale:a.scale,offset:a.offset,mins:a.mins,maxs:a.maxs},e=u.workerPool.getWorker(y.LAS_DECODER);e.onmessage=function(c){var d=new THREE.BufferGeometry;d.isPoints=!0;var g=a.pointsCount,k=new Float32Array(c.data.position),h=new Uint8Array(c.data.color),l=new Float32Array(c.data.intensity),m=new Uint8Array(c.data.classification),p=new Uint8Array(c.data.returnNumber),n=new Uint8Array(c.data.numberOfReturns),q=new Uint16Array(c.data.pointSourceID),
w=new Uint8Array(c.data.indices);d.addAttribute('position',new THREE.BufferAttribute(k,3));d.addAttribute('color',new THREE.BufferAttribute(u.denormalizeUint8Array(h),4));d.addAttribute('intensity',new THREE.BufferAttribute(l,1));d.addAttribute('classification',new THREE.BufferAttribute(m,1));d.addAttribute('returnNumber',new THREE.BufferAttribute(p,1));d.addAttribute('numberOfReturns',new THREE.BufferAttribute(n,1));d.addAttribute('pointSourceID',new THREE.BufferAttribute(q,1));d.addAttribute('indices',
new THREE.BufferAttribute(w,4));d.attributes.indices.normalized=!0;k=new THREE.Box3((new THREE.Vector3).fromArray(c.data.tightBoundingBox.min),(new THREE.Vector3).fromArray(c.data.tightBoundingBox.max));d.boundingBox=b.node.boundingBox;b.node.tightBoundingBox=k;b.node.geometry=d;b.node.numPoints=g;b.node.loaded=!0;b.node.loading=!1;u.numNodesLoading--;b.node.mean=new THREE.Vector3(...c.data.mean);u.workerPool.returnWorker(y.LAS_DECODER,e)};e.postMessage(c,[c.buffer])}}class xa{constructor(){this.octreeDir=
this.url=null;this.spacing=0;this.pointAttributes=this.nodes=this.root=this.boundingBox=null;this.hierarchyStepSize=-1;this.loader=null}}class O extends W{constructor(a,b,c){super();this.id=O.IDCount++;this.name=a;this.index=parseInt(a.charAt(a.length-1));this.pcoGeometry=b;this.geometry=null;this.boundingBox=c;this.boundingSphere=c.getBoundingSphere(new THREE.Sphere);this.children={};this.numPoints=0;this.level=null;this.loaded=!1;this.oneTimeDisposeHandlers=[]}isGeometryNode(){return!0}getLevel(){return this.level}isTreeNode(){return!1}isLoaded(){return this.loaded}getBoundingSphere(){return this.boundingSphere}getBoundingBox(){return this.boundingBox}getChildren(){for(var a=
...
c.offset=g;'LAS'===d.pointAttributes||'LAZ'===d.pointAttributes?c.loader=new wa(d.version):(c.loader=new va(d.version,h,d.scale),c.pointAttributes=new F(c.pointAttributes));g={};k='r';h=new O(k,c,h);h.level=0;h.hasChildren=!0;h.spacing=c.spacing;h.numPoints=f.upTo('1.5')?d.hierarchy[0][1]:0;c.root=h;c.root.load();g[k]=h;if(f.upTo('1.4'))for(f=1;f<d.hierarchy.length;f++){k=d.hierarchy[f][0];var l=d.hierarchy[f][1];h=parseInt(k.charAt(k.length-1));var m=k.substring(0,k.length-1);m=g[m];var p=k.length-
1;h=aa.createChildAABB(m.boundingBox,h);h=new O(k,c,h);h.level=p;h.numPoints=l;h.spacing=c.spacing/Math.pow(2,p);m.addChild(h);g[k]=h}c.nodes=g;b(c)};e.onerror=function(c){u.numNodesLoading--;console.log('Potree: loading file failed.',a,c);b()};e.send(null)}static loadPointAttributes(a){a=a.pointAttributes;for(var b=new F,c=0;c<a.length;c++)b.add(t[a[c]]);return b}static createChildAABB(a,b){var c=a.min.clone();a=a.max.clone();var e=(new THREE.Vector3).subVectors(a,c);0<(b&1)?c.z+=e.z/2:a.z-=e.z/
2;0<(b&2)?c.y+=e.y/2:a.y-=e.y/2;0<(b&4)?c.x+=e.x/2:a.x-=e.x/2;return new THREE.Box3(c,a)}}class ya{load(a){if(!a.loaded){var b=a.url()+'.bin',c=new XMLHttpRequest;c.open('GET',b,!0);c.responseType='arraybuffer';c.overrideMimeType('text/plain; charset=x-user-defined');c.onreadystatechange=()=>{4===c.readyState&&(200===c.status?this.parse(a,c.response):console.log('Failed '+b+': '+c.status))};try{c.send(null)}catch(e){console.log('Failed request: '+e)}}}parse(a,b){var c=u.workerPool.getWorker(y.EPT_BINARY_DECODER);
c.onmessage=function(b){var d=new THREE.BufferGeometry;d.isPoints=!0;var e=b.data.numPoints,g=new Float32Array(b.data.position);d.addAttribute('position',new THREE.BufferAttribute(g,3));g=new Uint8Array(b.data.indices);d.addAttribute('indices',new THREE.BufferAttribute(g,4));b.data.color&&(g=new Uint8Array(b.data.color),d.addAttribute('color',new THREE.BufferAttribute(u.denormalizeUint8Array(g),4)));b.data.intensity&&(g=new Float32Array(b.data.intensity),d.addAttribute('intensity',new THREE.BufferAttribute(g,
1)));b.data.classification&&(g=new Uint8Array(b.data.classification),d.addAttribute('classification',new THREE.BufferAttribute(g,1)));b.data.returnNumber&&(g=new Uint8Array(b.data.returnNumber),d.addAttribute('returnNumber',new THREE.BufferAttribute(g,1)));b.data.numberOfReturns&&(g=new Uint8Array(b.data.numberOfReturns),d.addAttribute('numberOfReturns',new THREE.BufferAttribute(g,1)));b.data.pointSourceId&&(g=new Uint16Array(b.data.pointSourceId),d.addAttribute('pointSourceID',new THREE.BufferAttribute(g,
1)));d.attributes.indices.normalized=!0;g=new THREE.Box3((new THREE.Vector3).fromArray(b.data.tightBoundingBox.min),(new THREE.Vector3).fromArray(b.data.tightBoundingBox.max));a.doneLoading(d,g,e,new THREE.Vector3(...b.data.mean));u.workerPool.returnWorker(y.EPT_BINARY_DECODER,c)};b={buffer:b,schema:a.ept.schema,scale:a.ept.eptScale,offset:a.ept.eptOffset,mins:(a=>[a.x,a.y,a.z])(a.key.b.min)};c.postMessage(b,[b.buffer])}}class za{load(a){if(!a.loaded){var b=a.url()+'.laz',c=new XMLHttpRequest;c.open('GET',
b,!0);c.responseType='arraybuffer';c.overrideMimeType('text/plain; charset=x-user-defined');c.onreadystatechange=()=>{4===c.readyState&&(200===c.status?this.parse(a,c.response):console.log('Failed '+b+': '+c.status))};c.send(null)}}parse(a,b){var c=new J(b),e=new Oa(a);c.open().then(()=>{c.isOpen=!0;return c.getHeader()}).then(b=>{var d=0,g=a=>[a.x,a.y,a.z],k=g(a.key.b.min),h=g(a.key.b.max),l=()=>c.readData(1E6,0,1).then(function(a){var f=new ea(a.buffer,b.pointsFormatId,b.pointsStructSize,a.count,
b.scale,b.offset,k,h);f.extraBytes=b.extraBytes;f.pointsFormatId=b.pointsFormatId;e.push(f);d+=a.count;if(a.hasMoreData)return l();b.totalRead=d;b.versionAsString=c.versionAsString;b.isCompressed=c.isCompressed;return null});return l()}).then(()=>c.close()).then(()=>c.isOpen=!1).catch(a=>{console.log('Error reading LAZ:',a);if(c.isOpen)c.close().then(()=>{c.isOpen=!1;throw a;});else throw a;})}}class Oa{constructor(a){this.node=a}push(a){var b=u.workerPool.getWorker(y.EPT_LAS_ZIP_DECODER);b.onmessage=
c=>{var d=new THREE.BufferGeometry;d.isPoints=!0;var e=a.pointsCount,g=new Float32Array(c.data.position),k=new Uint8Array(c.data.color),h=new Float32Array(c.data.intensity),l=new Uint8Array(c.data.classification),m=new Uint8Array(c.data.returnNumber),p=new Uint8Array(c.data.numberOfReturns),n=new Uint16Array(c.data.pointSourceID),q=new Uint8Array(c.data.indices);d.addAttribute('position',new THREE.BufferAttribute(g,3));d.addAttribute('color',new THREE.BufferAttribute(u.denormalizeUint8Array(k),4));
d.addAttribute('intensity',new THREE.BufferAttribute(h,1));d.addAttribute('classification',new THREE.BufferAttribute(l,1));d.addAttribute('returnNumber',new THREE.BufferAttribute(m,1));d.addAttribute('numberOfReturns',new THREE.BufferAttribute(p,1));d.addAttribute('pointSourceID',new THREE.BufferAttribute(n,1));d.addAttribute('indices',new THREE.BufferAttribute(q,4));d.attributes.indices.normalized=!0;g=new THREE.Box3((new THREE.Vector3).fromArray(c.data.tightBoundingBox.min),(new THREE.Vector3).fromArray(c.data.tightBoundingBox.max));
this.node.doneLoading(d,g,e,new THREE.Vector3(...c.data.mean));u.workerPool.returnWorker(y.EPT_LAS_ZIP_DECODER,b)};var c={buffer:a.arrayb,numPoints:a.pointsCount,pointSize:a.pointSize,pointFormatID:a.pointsFormatId,scale:a.scale,offset:a.offset,mins:a.mins,maxs:a.maxs};b.postMessage(c,[c.buffer])}}class D{static toVector3(a,b){return(new THREE.Vector3).fromArray(a,b||0)}static toBox3(a){return new THREE.Box3(D.toVector3(a),D.toVector3(a,3))}static findDim(a,b){a=a.find(a=>a.name==b);if(!a)throw Error('Failed to find '+
b+' in schema');return a}static sphereFrom(a){return a.getBoundingSphere(new THREE.Sphere)}}class Aa{constructor(a,b){let c=b.schema,e=b.bounds,d=b.boundsConforming;var f=[D.findDim(c,'X'),D.findDim(c,'Y'),D.findDim(c,'Z')];let g=f.map(a=>a.scale||1);f=f.map(a=>a.offset||0);this.eptScale=D.toVector3(g);this.eptOffset=D.toVector3(f);this.url=a;this.info=b;this.type='ept';this.schema=c;this.span=b.span||b.ticks;this.boundingBox=D.toBox3(e);this.tightBoundingBox=D.toBox3(d);this.offset=D.toVector3([0,
0,0]);this.boundingSphere=D.sphereFrom(this.boundingBox);this.tightBoundingSphere=D.sphereFrom(this.tightBoundingBox);this.version=new E('1.6');this.fallbackProjection=this.projection=null;b.srs&&b.srs.horizontal&&(this.projection=b.srs.authority+':'+b.srs.horizontal);b.srs.wkt&&(this.projection?this.fallbackProjection=b.srs.wkt:this.projection=b.srs.wkt);this.pointAttributes='LAZ';this.spacing=(this.boundingBox.max.x-this.boundingBox.min.x)/this.span;this.loader='binary'==(b.dataType||'laszip')?
new ya:new za}}class Ba{constructor(a,b,c,e,d,f){this.ept=a;this.b=b;this.d=c;this.x=e||0;this.y=d||0;this.z=f||0}name(){return this.d+'-'+this.x+'-'+this.y+'-'+this.z}step(a,b,c){let e=this.b.min.clone(),d=this.b.max.clone(),f=(new THREE.Vector3).subVectors(d,e);a?e.x+=f.x/2:d.x-=f.x/2;b?e.y+=f.y/2:d.y-=f.y/2;c?e.z+=f.z/2:d.z-=f.z/2;return new Ba(this.ept,new THREE.Box3(e,d),this.d+1,2*this.x+a,2*this.y+b,2*this.z+c)}children(){for(var a=[],b=0;2>b;++b)for(var c=0;2>c;++c)for(var e=0;2>e;++e){var d=
this.step(b,c,e).name();a.includes(d)||(a=a.concat(d))}return a}}class ba extends W{constructor(a,b,c,e,d,f){super();this.ept=a;this.key=new Ba(this.ept,b||this.ept.boundingBox,c||0,e,d,f);this.id=ba.IDCount++;this.geometry=null;this.tightBoundingBox=this.boundingBox=this.key.b;this.spacing=this.ept.spacing/Math.pow(2,this.key.d);this.boundingSphere=D.sphereFrom(this.boundingBox);this.hasChildren=!1;this.children={};this.numPoints=-1;this.level=this.key.d;this.loading=this.loaded=!1;this.oneTimeDisposeHandlers=
[];a=this.key;this.name=this.toPotreeName(a.d,a.x,a.y,a.z);this.index=parseInt(this.name.charAt(this.name.length-1))}isGeometryNode(){return!0}getLevel(){return this.level}isTreeNode(){return!1}isLoaded(){return this.loaded}getBoundingSphere(){return this.boundingSphere}getBoundingBox(){return this.boundingBox}url(){return this.ept.url+'ept-data/'+this.filename()}getNumPoints(){return this.numPoints}filename(){return this.key.name()}getChildren(){let a=[];for(let b=0;8>b;b++)this.children[b]&&a.push(this.children[b]);
return a}addChild(a){this.children[a.index]=a;a.parent=this}load(){this.loaded||this.loading||u.numNodesLoading>=u.maxNodesLoading||(this.loading=!0,u.numNodesLoading++,-1===this.numPoints&&this.loadHierarchy(),this.loadPoints())}loadPoints(){this.ept.loader.load(this)}async loadHierarchy(){let a={};a[this.filename()]=this;this.hasChildren=!1;let b=`${this.ept.url}ept-hierarchy/${this.filename()}.json`,c=await (await fetch(b)).json();Object.keys(c).sort((a,b)=>{let [c,d,e,h]=a.split('-').map(a=>parseInt(a,
10)),[l,m,p,n]=b.split('-').map(a=>parseInt(a,10));return c<l?-1:c>l?1:d<m?-1:d>m?1:e<p?-1:e>p?1:h<n?-1:h>n?1:0}).forEach(b=>{let [d,e,g,k]=b.split('-').map(a=>parseInt(a,10)),h=a[d-1+'-'+(e>>1)+'-'+(g>>1)+'-'+(k>>1)];if(h){h.hasChildren=!0;var l=h.key.step(e&1,g&1,k&1),m=new ba(this.ept,l.b,l.d,l.x,l.y,l.z);m.level=d;m.numPoints=c[b];h.addChild(m);a[l.name()]=m}})}doneLoading(a,b,c,e){a.boundingBox=this.boundingBox;this.geometry=a;this.tightBoundingBox=b;this.numPoints=c;this.mean=e;this.loaded=
!0;this.loading=!1;u.numNodesLoading--}toPotreeName(a,b,c,e){for(var d='r',f=0;f<a;++f){var g=1<<a-f-1,k=0;b&g&&(k+=4);c&g&&(k+=2);e&g&&(k+=1);d+=k}return d}dispose(){if(this.geometry&&null!=this.parent){this.geometry.dispose();this.geometry=null;this.loaded=!1;for(let a=0;a<this.oneTimeDisposeHandlers.length;a++)(0,this.oneTimeDisposeHandlers[a])();this.oneTimeDisposeHandlers=[]}}}ba.IDCount=0;class Ca{static async load(a,b){var c=await (await fetch(a)).json();a=a.substr(0,a.lastIndexOf('ept.json'));
c=new Aa(a,c);a=new ba(c);c.root=a;c.root.load();b(c)}}class L{static generateDataTexture(a,b,c){var e=a*b,d=new Uint8Array(4*a*b),f=Math.floor(255*c.r),g=Math.floor(255*c.g);c=Math.floor(255*c.b);for(var k=0;k<e;k++)d[3*k]=f,d[3*k+1]=g,d[3*k+2]=c;a=new THREE.DataTexture(d,a,b,THREE.RGBAFormat);a.needsUpdate=!0;a.magFilter=THREE.NearestFilter;return a}static computeTransformedBoundingBox(a,b){a=[(new THREE.Vector3(a.min.x,a.min.y,a.min.z)).applyMatrix4(b),(new THREE.Vector3(a.min.x,a.min.y,a.min.z)).applyMatrix4(b),
(new THREE.Vector3(a.max.x,a.min.y,a.min.z)).applyMatrix4(b),(new THREE.Vector3(a.min.x,a.max.y,a.min.z)).applyMatrix4(b),(new THREE.Vector3(a.min.x,a.min.y,a.max.z)).applyMatrix4(b),(new THREE.Vector3(a.min.x,a.max.y,a.max.z)).applyMatrix4(b),(new THREE.Vector3(a.max.x,a.max.y,a.min.z)).applyMatrix4(b),(new THREE.Vector3(a.max.x,a.min.y,a.max.z)).applyMatrix4(b),(new THREE.Vector3(a.max.x,a.max.y,a.max.z)).applyMatrix4(b)];b=new THREE.Box3;b.setFromPoints(a);return b}}var Da={RAINBOW:[[0,new THREE.Color(.278,
0,.714)],[1/6,new THREE.Color(0,0,1)],[2/6,new THREE.Color(0,1,1)],[.5,new THREE.Color(0,1,0)],[4/6,new THREE.Color(1,1,0)],[5/6,new THREE.Color(1,.64,0)],[1,new THREE.Color(1,0,0)]],SPECTRAL:[[0,new THREE.Color(.3686,.3098,.6353)],[.1,new THREE.Color(.1961,.5333,.7412)],[.2,new THREE.Color(.4,.7608,.6471)],[.3,new THREE.Color(.6706,.8667,.6431)],[.4,new THREE.Color(.902,.9608,.5961)],[.5,new THREE.Color(1,1,.749)],[.6,new THREE.Color(.9961,.8784,.5451)],[.7,new THREE.Color(.9922,.6824,.3804)],[.8,
new THREE.Color(.9569,.4275,.2627)],[.9,new THREE.Color(.8353,.2431,.3098)],[1,new THREE.Color(.6196,.0039,.2588)]],PLASMA:[[0,new THREE.Color(.241,.015,.61)],[.1,new THREE.Color(.387,.001,.654)],[.2,new THREE.Color(.524,.025,.653)],[.3,new THREE.Color(.651,.125,.596)],[.4,new THREE.Color(.752,.227,.513)],[.5,new THREE.Color(.837,.329,.431)],[.6,new THREE.Color(.907,.435,.353)],[.7,new THREE.Color(.963,.554,.272)],[.8,new THREE.Color(.992,.681,.195)],[.9,new THREE.Color(.987,.822,.144)],[1,new THREE.Color(.94,
.975,.131)]],YELLOW_GREEN:[[0,new THREE.Color(.1647,.2824,.3451)],[.1,new THREE.Color(.1338,.3555,.4227)],[.2,new THREE.Color(.061,.4319,.4864)],[.3,new THREE.Color(0,.5099,.5319)],[.4,new THREE.Color(0,.5881,.5569)],[.5,new THREE.Color(.137,.665,.5614)],[.6,new THREE.Color(.2906,.7395,.5477)],[.7,new THREE.Color(.4453,.8099,.5201)],[.8,new THREE.Color(.6102,.8748,.485)],[.9,new THREE.Color(.7883,.9323,.4514)],[1,new THREE.Color(.9804,.9804,.4314)]],VIRIDIS:[[0,new THREE.Color(.267,.005,.329)],[.1,
new THREE.Color(.283,.141,.458)],[.2,new THREE.Color(.254,.265,.53)],[.3,new THREE.Color(.207,.372,.553)],[.4,new THREE.Color(.164,.471,.558)],[.5,new THREE.Color(.128,.567,.551)],[.6,new THREE.Color(.135,.659,.518)],[.7,new THREE.Color(.267,.749,.441)],[.8,new THREE.Color(.478,.821,.318)],[.9,new THREE.Color(.741,.873,.15)],[1,new THREE.Color(.993,.906,.144)]],INFERNO:[[0,new THREE.Color(.077,.042,.206)],[.1,new THREE.Color(.225,.036,.388)],[.2,new THREE.Color(.373,.074,.432)],[.3,new THREE.Color(.522,
.128,.42)],[.4,new THREE.Color(.665,.182,.37)],[.5,new THREE.Color(.797,.255,.287)],[.6,new THREE.Color(.902,.364,.184)],[.7,new THREE.Color(.969,.516,.063)],[.8,new THREE.Color(.988,.683,.072)],[.9,new THREE.Color(.961,.859,.298)],[1,new THREE.Color(.988,.998,.645)]],GRAYSCALE:[[0,new THREE.Color(0,0,0)],[1,new THREE.Color(1,1,1)]]},P={};P.vertex='\nprecision highp float;\nprecision highp int;\n\n#define MAX_CLIP_POLYGONS 8\n\n'+THREE.ShaderChunk.common+'\n'+THREE.ShaderChunk.logdepthbuf_pars_vertex+
...
THREE.ShaderChunk.logdepthbuf_fragment+'\n\n\t#if defined weighted_splats\n\t\tfloat distance = 2.0 * length(gl_PointCoord.xy - 0.5);\n\t\tfloat weight = max(0.0, 1.0 - distance);\n\t\tweight = pow(weight, 1.5);\n\n\t\tgl_FragColor.a = weight;\n\t\tgl_FragColor.xyz = gl_FragColor.xyz * weight;\n\t#endif\n}';S.prototype=Object.create(THREE.Texture.prototype);S.prototype.constructor=S;S.prototype.isCanvasTexture=!0;class M extends THREE.RawShaderMaterial{constructor(a={}){super();this.visibleNodesTexture=
L.generateDataTexture(2048,1,new THREE.Color(16777215));this.visibleNodesTexture.minFilter=THREE.NearestFilter;this.visibleNodesTexture.magFilter=THREE.NearestFilter;var b=function(a,b){return void 0!==a?a:b},c=b(a.size,1),e=b(a.minSize,2),d=b(a.maxSize,50);a=b(a.treeType,X.OCTREE);this._pointSizeType=Q.FIXED;this._shape=Y.SQUARE;this._pointColorType=A.RGB;this._weighted=this._useClipBox=!1;this._gradient=Da.SPECTRAL;this._treeType=a;this._snapEnabled=this._useEDL=!1;this._numSnapshots=0;this._defaultElevationRangeChanged=
this._defaultIntensityRangeChanged=!1;this.clipBoxes=[];this.clipPolygons=[];this.gradientTexture=M.generateGradientTexture(this._gradient);this.fog=this.lights=!1;this.defines=new Map;this.attributes={position:{type:'fv',value:[]},color:{type:'fv',value:[]},normal:{type:'fv',value:[]},intensity:{type:'f',value:[]},classification:{type:'f',value:[]},returnNumber:{type:'f',value:[]},numberOfReturns:{type:'f',value:[]},pointSourceID:{type:'f',value:[]},indices:{type:'fv',value:[]}};this.uniforms={level:{type:'f',
value:0},vnStart:{type:'f',value:0},spacing:{type:'f',value:1},blendHardness:{type:'f',value:2},blendDepthSupplement:{type:'f',value:0},fov:{type:'f',value:1},screenWidth:{type:'f',value:1},screenHeight:{type:'f',value:1},near:{type:'f',value:.1},far:{type:'f',value:1},uColor:{type:'c',value:new THREE.Color(16777215)},uOpacity:{type:'f',value:1},size:{type:'f',value:c},minSize:{type:'f',value:e},maxSize:{type:'f',value:d},octreeSize:{type:'f',value:0},bbSize:{type:'fv',value:[0,0,0]},elevationRange:{type:'2fv',
value:[0,0]},clipBoxCount:{type:'f',value:0},clipPolygonCount:{type:'i',value:0},clipBoxes:{type:'Matrix4fv',value:[]},clipPolygons:{type:'3fv',value:[]},clipPolygonVCount:{type:'iv',value:[]},clipPolygonVP:{type:'Matrix4fv',value:[]},visibleNodes:{type:'t',value:this.visibleNodesTexture},pcIndex:{type:'f',value:0},gradient:{type:'t',value:this.gradientTexture},classificationLUT:{type:'t',value:this.classificationTexture},uHQDepthMap:{type:'t',value:null},toModel:{type:'Matrix4f',value:[]},diffuse:{type:'fv',
value:[1,1,1]},transition:{type:'f',value:.5},intensityRange:{type:'fv',value:[0,65E3]},intensityGamma:{type:'f',value:1},intensityContrast:{type:'f',value:0},intensityBrightness:{type:'f',value:0},rgbGamma:{type:'f',value:1},rgbContrast:{type:'f',value:0},rgbBrightness:{type:'f',value:0},wRGB:{type:'f',value:1},wIntensity:{type:'f',value:0},wElevation:{type:'f',value:0},wClassification:{type:'f',value:0},wReturnNumber:{type:'f',value:0},wSourceID:{type:'f',value:0},useOrthographicCamera:{type:'b',
value:!1},clipTask:{type:'i',value:1},clipMethod:{type:'i',value:1},uSnapshot:{type:'tv',value:[]},uSnapshotDepth:{type:'tv',value:[]},uSnapView:{type:'Matrix4fv',value:[]},uSnapProj:{type:'Matrix4fv',value:[]},uSnapProjInv:{type:'Matrix4fv',value:[]},uSnapViewInv:{type:'Matrix4fv',value:[]},uShadowColor:{type:'3fv',value:[0,0,0]},uFilterReturnNumberRange:{type:'fv',value:[0,7]},uFilterNumberOfReturnsRange:{type:'fv',value:[0,7]},uFilterGPSTimeClipRange:{type:'fv',value:[0,7]}};this.classification=
Ea.DEFAULT;this.defaultAttributeValues.normal=[0,0,0];this.defaultAttributeValues.classification=[0,0,0];this.defaultAttributeValues.indices=[0,0,0,0];c=this.getDefines();this.vertexShader=c+P.vertex;this.fragmentShader=c+P.fragment;this.vertexColors=THREE.VertexColors}setDefine(a,b){void 0!==b&&null!==b?this.defines.get(a)!==b&&(this.defines.set(a,b),this.updateShaderSource()):this.removeDefine(a)}removeDefine(a){this.defines.delete(a)}updateShaderSource(){var a=this.getDefines();this.vertexShader=
a+P.vertex;this.fragmentShader=a+P.fragment;1===this.opacity?(this.blending=THREE.NoBlending,this.transparent=!1,this.depthWrite=this.depthTest=!0,this.depthFunc=THREE.LessEqualDepth):1>this.opacity&&!this.useEDL&&(this.blending=THREE.AdditiveBlending,this.transparent=!0,this.depthTest=!1,this.depthWrite=!0,this.depthFunc=THREE.AlwaysDepth);this.weighted&&(this.blending=THREE.AdditiveBlending,this.depthTest=this.transparent=!0,this.depthWrite=!1);this.needsUpdate=!0}onBeforeCompile(a,b){b.capabilities.logarithmicDepthBuffer&&
(a.fragmentShader='#define USE_LOGDEPTHBUF\n#define USE_LOGDEPTHBUF_EXT\n#define EPSILON 1e-6\n'+a.fragmentShader,a.vertexShader='#define USE_LOGDEPTHBUF\n#define USE_LOGDEPTHBUF_EXT\n#define EPSILON 1e-6\n'+a.vertexShader)}getDefines(){var a=[];this.pointSizeType===Q.FIXED?a.push('#define fixed_point_size'):this.pointSizeType===Q.ATTENUATED?a.push('#define attenuated_point_size'):this.pointSizeType===Q.ADAPTIVE&&a.push('#define adaptive_point_size');this.shape===Y.SQUARE?a.push('#define square_point_shape'):
this.shape===Y.CIRCLE?a.push('#define circle_point_shape'):this.shape===Y.PARABOLOID&&a.push('#define paraboloid_point_shape');this._useEDL&&a.push('#define use_edl');this._snapEnabled&&a.push('#define snap_enabled');this._pointColorType===A.RGB?a.push('#define color_type_rgb'):this._pointColorType===A.COLOR?a.push('#define color_type_color'):this._pointColorType===A.DEPTH?a.push('#define color_type_depth'):this._pointColorType===A.HEIGHT?a.push('#define color_type_height'):this._pointColorType===
A.INTENSITY?a.push('#define color_type_intensity'):this._pointColorType===A.INTENSITY_GRADIENT?a.push('#define color_type_intensity_gradient'):this._pointColorType===A.LOD?a.push('#define color_type_lod'):this._pointColorType===A.POINT_INDEX?a.push('#define color_type_point_index'):this._pointColorType===A.CLASSIFICATION?a.push('#define color_type_classification'):this._pointColorType===A.RETURN_NUMBER?a.push('#define color_type_return_number'):this._pointColorType===A.SOURCE?a.push('#define color_type_source'):
this._pointColorType===A.NORMAL?a.push('#define color_type_normal'):this._pointColorType===A.PHONG?a.push('#define color_type_phong'):this._pointColorType===A.RGB_HEIGHT?a.push('#define color_type_rgb_height'):this._pointColorType===A.COMPOSITE&&a.push('#define color_type_composite');this._treeType===X.OCTREE?a.push('#define tree_type_octree'):this._treeType===X.KDTREE&&a.push('#define tree_type_kdtree');this.weighted&&a.push('#define weighted_splats');var b;for([,b]of this.defines)a.push(b);return a.join('\n')}setClipBoxes(a){if(a){var b=
this.clipBoxes.length!==a.length&&(0===a.length||0===this.clipBoxes.length);this.uniforms.clipBoxCount.value=this.clipBoxes.length;this.clipBoxes=a;b&&this.updateShaderSource();this.uniforms.clipBoxes.value=new Float32Array(16*this.clipBoxes.length);for(b=0;b<this.clipBoxes.length;b++)this.uniforms.clipBoxes.value.set(a[b].inverse.elements,16*b);for(b=0;b<this.uniforms.clipBoxes.value.length;b++)Number.isNaN(this.uniforms.clipBoxes.value[b])&&(this.uniforms.clipBoxes.value[b]=Infinity)}}setClipPolygons(a,
b){a&&(this.clipPolygons=a,this.clipPolygons.length!==a.length&&this.updateShaderSource())}get gradient(){return this._gradient}set gradient(a){this._gradient!==a&&(this._gradient=a,this.gradientTexture=M.generateGradientTexture(this._gradient),this.uniforms.gradient.value=this.gradientTexture)}get useOrthographicCamera(){return this.uniforms.useOrthographicCamera.value}set useOrthographicCamera(a){this.uniforms.useOrthographicCamera.value!==a&&(this.uniforms.useOrthographicCamera.value=a)}get classification(){return this._classification}set classification(a){var b=
...
a&&(this.uniforms.wSourceID.value=a,this.dispatchEvent({type:'material_property_changed',target:this}))}static generateGradientTexture(a){var b=document.createElement('canvas');b.width=64;b.height=64;var c=b.getContext('2d');c.rect(0,0,64,64);for(var e=c.createLinearGradient(0,0,64,64),d=0;d<a.length;d++){var f=a[d];e.addColorStop(f[0],'#'+f[1].getHexString())}c.fillStyle=e;c.fill();a=new S(b);a.needsUpdate=!0;a.minFilter=THREE.LinearFilter;return a}static generateClassificationTexture(a){for(var b=
...
parseInt(a.name[a.name.length-1]);b.sceneNode.remove(c.sceneNode);b.children[d]=a});return c}updateVisibleBounds(){for(var a=[],b=0;b<this.visibleNodes.length;b++){for(var c=this.visibleNodes[b],e=!0,d=0;d<c.children.length;d++){var f=c.children[d];f instanceof ca?e=e&&!f.sceneNode.visible:f instanceof O&&(e=!0)}e&&a.push(c)}this.visibleBounds.min=new THREE.Vector3(Infinity,Infinity,Infinity);this.visibleBounds.max=new THREE.Vector3(-Infinity,-Infinity,-Infinity);for(b=0;b<a.length;b++)c=a[b],this.visibleBounds.expandByPoint(c.getBoundingBox().min),
...
return{data:b,offsets:c}}get progress(){return this.pcoGeometry.root?0<u.numNodesLoading?0:1:0}}class Pa{constructor(){this.pcoGeometry=this.number=this.boundingBox=this.right=this.left=null;this.loaded=!1;this.level=this.numPoints=0;this.children=[];this.oneTimeDisposeHandlers=[]}isGeometryNode(){return!0}isTreeNode(){return!1}isLoaded(){return this.loaded}getBoundingSphere(){return this.boundingSphere}getBoundingBox(){return this.boundingBox}getChildren(){var a=[];this.left&&a.push(this.left);this.right&&
...
new THREE.BufferGeometry;B.isPoints=!0;B.addAttribute('position',new THREE.BufferAttribute(k,3));B.addAttribute('color',new THREE.BufferAttribute(u.denormalizeUint8Array(h),4));B.addAttribute('intensity',new THREE.BufferAttribute(l,1));B.addAttribute('classification',new THREE.BufferAttribute(m,1));var D=new THREE.BufferAttribute(new Uint8Array(p),4,!0);B.addAttribute('indices',D);a.geometry=B;a.numPoints=f;a.loaded=!0;a.loading=!1;u.numNodesLoading--}catch(Qa){console.error('Potree: Exception thrown parsing points.',
Qa),u.numNodesLoading--}};c.onerror=function(){u.numNodesLoading--;console.log('Potree: Failed to load file, '+c.status+', file: '+b)};c.send(null)}}dispose(){if(this.geometry&&null!=this.parent){this.geometry.dispose();this.geometry=null;this.loaded=!1;for(var a=0;a<this.oneTimeDisposeHandlers.length;a++)(0,this.oneTimeDisposeHandlers[a])();this.oneTimeDisposeHandlers=[]}}getNumPoints(){return this.numPoints}}class ja extends THREE.EventDispatcher{constructor(){super();this.version=this.numPoints=
0;this.boundingBox=null;this.numNodes=0;this.root=this.url=this.provider=this.name=null;this.levels=0;this._spacing=null;this.pointAttributes=new F(['POSITION_CARTESIAN','COLOR_PACKED'])}static load(a,b){var c=new XMLHttpRequest;c.overrideMimeType('text/plain');c.open('GET',a+'?info',!0);c.onreadystatechange=function(){try{if(4===c.readyState&&200===c.status){var e=JSON.parse(c.responseText),d=new ja;d.url=a;d.name=e.Name;d.provider=e.Provider;d.numNodes=e.Nodes;d.numPoints=e.Points;d.version=e.Version;
d.boundingBox=new THREE.Box3((new THREE.Vector3).fromArray(e.BoundingBox.slice(0,3)),(new THREE.Vector3).fromArray(e.BoundingBox.slice(3,6)));e.Spacing&&(d.spacing=e.Spacing);var f=d.boundingBox.min.clone().multiplyScalar(-1);d.boundingBox.min.add(f);d.boundingBox.max.add(f);d.offset=f;var g=new THREE.Vector3;d.boundingBox.center(g);var k=d.boundingBox.size(new THREE.Vector3).length()/2;d.boundingSphere=new THREE.Sphere(g,k);d.loadHierarchy();b(d)}else 4===c.readyState&&b(null)}catch(h){console.error(h.message),
b(null)}};c.send(null)}loadHierarchy(){var a=this.url+'?tree',b=new XMLHttpRequest;b.overrideMimeType('text/plain');b.open('GET',a,!0);b.responseType='arraybuffer';b.onreadystatechange=()=>{if(4===b.readyState&&200===b.status){var a=b.response,e=a.byteLength/3;a=new DataView(a);for(var d=[],f=null,g=0,k=0;k<e;k++){var h=a.getUint8(3*k,!0),l=0<(h&1),m=0<(h&2),p=0<(h&8),n=0<(h&16),q=null;0<(h&4)?q='X':p&&(q='Y');n&&(q='Z');h=new Pa;h.hasLeft=l;h.hasRight=m;h.split=q;h.isLeaf=!l&&!m;h.number=k;h.left=
null;h.right=null;h.pcoGeometry=this;h.level=d.length;g=Math.max(g,h.level);0<d.length?(l=d[d.length-1],h.boundingBox=l.boundingBox.clone(),m=l.boundingBox.size(new THREE.Vector3),l.hasLeft&&!l.left?(l.left=h,l.children.push(h),'X'===l.split?h.boundingBox.max.x=h.boundingBox.min.x+m.x/2:'Y'===l.split?h.boundingBox.max.y=h.boundingBox.min.y+m.y/2:'Z'===l.split&&(h.boundingBox.max.z=h.boundingBox.min.z+m.z/2),l=new THREE.Vector3,h.boundingBox.center(l),m=h.boundingBox.size(new THREE.Vector3).length()/
2):(l.right=h,l.children.push(h),'X'===l.split?h.boundingBox.min.x+=m.x/2:'Y'===l.split?h.boundingBox.min.y+=m.y/2:'Z'===l.split&&(h.boundingBox.min.z+=m.z/2),l=new THREE.Vector3,h.boundingBox.center(l),m=h.boundingBox.size(new THREE.Vector3).length()/2),h.boundingSphere=new THREE.Sphere(l,m)):(f=h,f.boundingBox=this.boundingBox.clone(),l=new THREE.Vector3,f.boundingBox.center(l),m=f.boundingBox.size(new THREE.Vector3).length()/2,f.boundingSphere=new THREE.Sphere(l,m));l=h.boundingBox.size(new THREE.Vector3);
h.spacing=(l.x+l.y+l.z)/3/75;h.estimatedSpacing=h.spacing;d.push(h);if(h.isLeaf)for(h=!1;!h&&0<d.length;)d.pop(),h=d[d.length-1],h=0<d.length&&h.hasRight&&null==h.right}this.root=f;this.levels=g;this.dispatchEvent({type:'hierarchy_loaded'})}};b.send(null)}get spacing(){if(this._spacing)return this._spacing;if(this.root)return this.root.spacing}set spacing(a){this._spacing=a}}fa.prototype={push:function(a){this.content.push(a);this.bubbleUp(this.content.length-1)},pop:function(){var a=this.content[0],
...
d;a=e}},sinkDown:function(a){for(var b=this.content.length,c=this.content[a],e=this.scoreFunction(c);;){var d=2*(a+1),f=d-1,g=null;if(f<b){var k=this.scoreFunction(this.content[f]);k<e&&(g=f)}d<b&&this.scoreFunction(this.content[d])<(null==g?e:k)&&(g=d);if(null==g)break;this.content[a]=this.content[g];this.content[g]=c;a=g}}};var Z={position:0,color:1,intensity:2,classification:3,returnNumber:4,numberOfReturns:5,pointSourceID:6,indices:7,normal:8,spacing:9},Ea={DEFAULT:{0:new THREE.Vector4(.5,.5,
.5,1),1:new THREE.Vector4(.5,.5,.5,1),2:new THREE.Vector4(.63,.32,.18,1),3:new THREE.Vector4(0,1,0,1),4:new THREE.Vector4(0,.8,0,1),5:new THREE.Vector4(0,.6,0,1),6:new THREE.Vector4(1,.66,0,1),7:new THREE.Vector4(1,0,1,1),8:new THREE.Vector4(1,0,0,1),9:new THREE.Vector4(0,0,1,1),12:new THREE.Vector4(1,1,0,1),DEFAULT:new THREE.Vector4(.3,.6,.6,.5)}},U={NONE:0,HIGHLIGHT:1,SHOW_INSIDE:2,SHOW_OUTSIDE:3},Q={FIXED:0,ATTENUATED:1,ADAPTIVE:2},Y={SQUARE:0,CIRCLE:1,PARABOLOID:2},A={RGB:0,COLOR:1,DEPTH:2,HEIGHT:3,
ELEVATION:3,INTENSITY:4,INTENSITY_GRADIENT:5,LOD:6,LEVEL_OF_DETAIL:6,POINT_INDEX:7,CLASSIFICATION:8,RETURN_NUMBER:9,SOURCE:10,NORMAL:11,PHONG:12,RGB_HEIGHT:13,COMPOSITE:50},X={OCTREE:0,KDTREE:1};class Ra{constructor(){this.boundingBox=new THREE.Box3;this.numPoints=0;this.data={}}add(a){var b=this.numPoints,c=b+a.numPoints,e=Object.keys(this.data),d=Object.keys(a.data),f=new Set([...e,...d]),g;for(g of f)if(e.includes(g)&&d.includes(g)){var k=this.data[g].constructor;f=new k(this.data[g].length+a.data[g].length);
f.set(this.data[g],0);f.set(a.data[g],this.data[g].length);this.data[g]=f}else e.includes(g)&&!d.includes(g)?(f=this.data[g].length/this.numPoints,k=this.data[g].constructor,k=new k(f*c),k.set(this.data[g],0),this.data[g]=k):!e.includes(g)&&d.includes(g)&&(f=a.data[g].length/a.numPoints,k=a.data[g].constructor,k=new k(f*c),k.set(a.data[g],f*b),this.data[g]=k);this.numPoints=c;this.boundingBox.union(a.boundingBox)}}class ka{constructor(a,b){this.gl=a;this.texture=b;this.id=a.createTexture();this.target=
a.TEXTURE_2D;this.version=-1;this.update(b)}update(){if(this.texture.image){var a=this.gl,b=this.texture;if(this.version!==b.version){this.target=a.TEXTURE_2D;a.bindTexture(this.target,this.id);var c=K(a,b.format),e=b.image.width,d=b.image.height,f=K(a,b.type);a.pixelStorei(a.UNPACK_FLIP_Y_WEBGL,b.flipY);a.pixelStorei(a.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha);a.pixelStorei(a.UNPACK_ALIGNMENT,b.unpackAlignment);if(b instanceof THREE.DataTexture){var g=b.image.data;a.texParameteri(this.target,
a.TEXTURE_WRAP_S,a.CLAMP_TO_EDGE);a.texParameteri(this.target,a.TEXTURE_WRAP_T,a.CLAMP_TO_EDGE);a.texParameteri(this.target,a.TEXTURE_MAG_FILTER,K(a,b.magFilter));a.texParameteri(this.target,a.TEXTURE_MIN_FILTER,K(a,b.minFilter));a.texImage2D(this.target,0,c,e,d,0,c,f,g)}else b instanceof S&&(g=b.image,a.texParameteri(this.target,a.TEXTURE_WRAP_S,K(a,b.wrapS)),a.texParameteri(this.target,a.TEXTURE_WRAP_T,K(a,b.wrapT)),a.texParameteri(this.target,a.TEXTURE_MAG_FILTER,K(a,b.magFilter)),a.texParameteri(this.target,
a.TEXTURE_MIN_FILTER,K(a,b.minFilter)),a.texImage2D(this.target,0,c,c,f,g));a.bindTexture(this.target,null);this.version=b.version}}else this.version=this.texture.version}}class Ga{constructor(a,b,c,e){this.gl=a;this.name=b;this.vsSource=c;this.fsSource=e;this.cache=new Map;this.program=this.fs=this.vs=null;this.uniformLocations={};this.attributeLocations={};this.update(c,e)}update(a,b){this.vsSource=a;this.fsSource=b;this.linkProgram()}compileShader(a,b){var c=this.gl;c.shaderSource(a,b);c.compileShader(a);
if(!c.getShaderParameter(a,c.COMPILE_STATUS))throw a=c.getShaderInfoLog(a),Error('Potree: Could not compile shader '+this.name+', '+a);}linkProgram(){var a=this.gl;this.uniformLocations={};this.attributeLocations={};a.useProgram(null);var b=this.cache.get(`${this.vsSource}, ${this.fsSource}`);if(b)this.program=b.program,this.vs=b.vs,this.fs=b.fs,this.attributeLocations=b.attributeLocations,this.uniformLocations=b.uniformLocations;else{this.vs=a.createShader(a.VERTEX_SHADER);this.fs=a.createShader(a.FRAGMENT_SHADER);
this.program=a.createProgram();for(var c of Object.keys(Z))b=Z[c],a.bindAttribLocation(this.program,b,c);this.compileShader(this.vs,this.vsSource);this.compileShader(this.fs,this.fsSource);c=this.program;a.attachShader(c,this.vs);a.attachShader(c,this.fs);a.linkProgram(c);a.detachShader(c,this.vs);a.detachShader(c,this.fs);if(!a.getProgramParameter(c,a.LINK_STATUS))throw a=a.getProgramInfoLog(c),Error('Potree: Could not link program '+this.name+', '+a);for(var e=a.getProgramParameter(c,a.ACTIVE_ATTRIBUTES),
d=0;d<e;d++){var f=a.getActiveAttrib(c,d);b=a.getAttribLocation(c,f.name);this.attributeLocations[f.name]=b}e=a.getProgramParameter(c,a.ACTIVE_UNIFORMS);for(d=0;d<e;d++)f=a.getActiveUniform(c,d),b=a.getUniformLocation(c,f.name),this.uniformLocations[f.name]=b;b={program:this.program,vs:this.vs,fs:this.fs,attributeLocations:this.attributeLocations,uniformLocations:this.uniformLocations};this.cache.set(`${this.vsSource}, ${this.fsSource}`,b)}}setUniformMatrix4(a,b){const c=this.gl;a=this.uniformLocations[a];
null!=a&&(b=new Float32Array(b.elements),c.uniformMatrix4fv(a,!1,b))}setUniform1f(a,b){a=this.uniformLocations[a];null!=a&&this.gl.uniform1f(a,b)}setUniformBoolean(a,b){a=this.uniformLocations[a];null!=a&&this.gl.uniform1i(a,b)}setUniformTexture(a,b){a=this.uniformLocations[a];null!=a&&this.gl.uniform1i(a,b)}setUniform2f(a,b){a=this.uniformLocations[a];null!=a&&this.gl.uniform2f(a,b[0],b[1])}setUniform3f(a,b){a=this.uniformLocations[a];null!=a&&this.gl.uniform3f(a,b[0],b[1],b[2])}setUniform(a,b){b.constructor===
THREE.Matrix4?this.setUniformMatrix4(a,b):'number'===typeof b?this.setUniform1f(a,b):'boolean'===typeof b?this.setUniformBoolean(a,b):b instanceof ka?this.setUniformTexture(a,b):b instanceof Array?2===b.length?this.setUniform2f(a,b):3===b.length&&this.setUniform3f(a,b):console.error('Potree: Unhandled uniform type: ',a,b)}setUniform1i(a,b){a=this.uniformLocations[a];null!=a&&this.gl.uniform1i(a,b)}}class Ha{constructor(){this.numElements=0;this.vao=null;this.vbos=new Map}}class Ia extends THREE.Mesh{constructor(){super(new THREE.Geometry,
new THREE.MeshBasicMaterial({opacity:0,wireframe:!1,transparent:!0}));this.rotation.set(-Math.PI/2,0,0);this.frustumCulled=!0;this.pointclouds=[];this.nodeSize=30;this.pointBudget=1E10;this.nodeLoadRate=2}raycast(a,b){}setPointBudget(a){this.pointBudget=a}onBeforeRender(a,b,c,e,d,f){for(b=0;b<this.pointclouds.length;b++)this.pointclouds[b].minimumNodePixelSize=this.nodeSize;oa(this.pointclouds,c,a)}recalculateBoxGeometry(){var a=this.getBoundingBox(),b=a.size(new THREE.Vector3),c=a.center(new THREE.Vector3);
a=new THREE.Matrix4;a.makeTranslation(c.x,-c.z,c.y);b=(new THREE.BufferGeometry).fromGeometry(new THREE.BoxGeometry(b.x,b.z,b.y));b.applyMatrix(a);this.geometry=b}add(a){THREE.Object3D.prototype.add.call(this,a);a instanceof T&&(a.showBoundingBox=!1,a.generateDEM=!1,this.pointclouds.push(a),this.recalculateBoxGeometry())}remove(a){THREE.Object3D.prototype.remove.call(this,a);a instanceof T&&(a=this.pointclouds.indexOf(a),-1!==a&&(this.pointclouds.splice(a,1),this.recalculateBoxGeometry()))}getBoundingBox(){var a=
new THREE.Box3;this.updateMatrixWorld(!0);for(var b=0;b<this.pointclouds.length;b++){var c=this.pointclouds[b];c.updateMatrixWorld(!0);c=L.computeTransformedBoundingBox(c.pcoGeometry.tightBoundingBox?c.pcoGeometry.tightBoundingBox:c.boundingBox,c.matrixWorld);a.union(c)}return a}estimateHeightAt(a){var b=null,c=Infinity,e;for(e of this.pointclouds)if(void 0!==e.root.geometryNode){var d=null,f=Infinity,g=a.clone().sub(e.position);g.z=0;g=new THREE.Ray(g,new THREE.Vector3(0,0,1));for(var k=[e.root];0<
k.length;){var h=k.pop(),l=h.getBoundingBox();if(g.intersectBox(l)){l=h.geometryNode.mean.z+e.position.z+h.geometryNode.boundingBox.min.z;h.geometryNode.spacing<=f&&(d=l,f=h.geometryNode.spacing);for(var m of Object.keys(h.children))h.children[m].geometryNode&&k.push(h.children[m])}}if(null===b||f<c)b=d,c=f}return b}}class Sa extends Ia{constructor(){super();this.buffers=new Map;this.shaders=new Map;this.textures=new Map;this.types=new Map}getExtensions(a){this.types.set(Float32Array,a.FLOAT);this.types.set(Uint8Array,
a.UNSIGNED_BYTE);this.types.set(Uint16Array,a.UNSIGNED_SHORT);var b=a.getExtension('OES_vertex_array_object');a.createVertexArray=b.createVertexArrayOES.bind(b);a.bindVertexArray=b.bindVertexArrayOES.bind(b)}onBeforeRender(a,b,c,e,d,f){super.onBeforeRender(a,b,c,e,d,f);b=a.getContext();void 0===b.bindVertexArray&&this.getExtensions(b);e=this.fetchOctrees();for(var g of e.octrees)this.renderOctree(a,g,g.visibleNodes,c);b.activeTexture(b.TEXTURE1);b.bindTexture(b.TEXTURE_2D,null);a.state.reset()}createBuffer(a,
b){var c=new Ha;c.vao=a.createVertexArray();c.numElements=b.attributes.position.count;a.bindVertexArray(c.vao);for(var e in b.attributes){var d=b.attributes[e],f=a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,f);a.bufferData(a.ARRAY_BUFFER,d.array,a.STATIC_DRAW);var g=Z[e],k=d.normalized,h=this.types.get(d.array.constructor);void 0!==h&&(a.vertexAttribPointer(g,d.itemSize,h,k,0,0),a.enableVertexAttribArray(g));c.vbos.set(e,{handle:f,name:e,count:d.count,itemSize:d.itemSize,type:b.attributes.position.array.constructor,
version:0})}a.bindBuffer(a.ARRAY_BUFFER,null);a.bindVertexArray(null);return c}updateBuffer(a,b){var c=this.buffers.get(b);a.bindVertexArray(c.vao);for(var e in b.attributes){var d=b.attributes[e],f=Z[e],g=d.normalized,k=this.types.get(d.array.constructor);if(c.vbos.has(e)){var h=c.vbos.get(e).handle;c.vbos.get(e).version=d.version}else h=a.createBuffer(),c.vbos.set(e,{handle:h,name:e,count:d.count,itemSize:d.itemSize,type:b.attributes.position.array.constructor,version:d.version});a.bindBuffer(a.ARRAY_BUFFER,
h);a.bufferData(a.ARRAY_BUFFER,d.array,a.STATIC_DRAW);a.vertexAttribPointer(f,d.itemSize,k,g,0,0);a.enableVertexAttribArray(f)}a.bindBuffer(a.ARRAY_BUFFER,null);a.bindVertexArray(null)}fetchOctrees(){for(var a=[],b=[this];0<b.length;){var c=b.pop();c instanceof T?a.push(c):(c=c.children.filter(a=>a.visible),b.push(...c))}return{octrees:a}}renderNodes(a,b,c,e,d,f){a=a.getContext();b=b.material;d=d.matrixWorldInverse;var g=new THREE.Matrix4,k=new Float32Array(16),h;for(h of c)if(void 0===u.debug.allowedNodes||
u.debug.allowedNodes.includes(h.name)){var l=h.sceneNode.matrixWorld;g.multiplyMatrices(d,l);e&&(c=e.offsets.get(h),f.setUniform1f('uVNStart',c));c=h.getLevel();f.setUniform('uDebug',!0===h.debug);if(h instanceof ca)var m=0===Object.keys(h.children).length;else h instanceof ia&&(m=h.geometryNode.isLeaf);f.setUniform('uIsLeafNode',m);var p=f.uniformLocations.modelMatrix;p&&(k.set(l.elements),a.uniformMatrix4fv(p,!1,k));p=f.uniformLocations.modelViewMatrix;k.set(g.elements);a.uniformMatrix4fv(p,!1,
k);if(b.clipPolygons&&0<b.clipPolygons.length){p=[];var n=[];for(r of b.clipPolygons){d=r.viewMatrix;var q=r.projMatrix.clone().multiply(d).multiply(l);p.push(r.markers.length);n.push(q)}l=[].concat(...n.map(a=>a.elements));q=Array(24*b.clipPolygons.length);for(n=0;n<b.clipPolygons.length;n++){var r=b.clipPolygons[n];for(var t=0;t<r.markers.length;t++)q[24*n+3*t]=r.markers[t].position.x,q[24*n+(3*t+1)]=r.markers[t].position.y,q[24*n+(3*t+2)]=r.markers[t].position.z}a.uniform1iv(f.uniformLocations['uClipPolygonVCount[0]'],
p);a.uniformMatrix4fv(f.uniformLocations['uClipPolygonWVP[0]'],!1,l);a.uniform3fv(f.uniformLocations['uClipPolygonVertices[0]'],q)}f.setUniform1f('uLevel',c);f.setUniform1f('uNodeSpacing',h.geometryNode.estimatedSpacing);f.setUniform1f('uPCIndex',n);c=h.geometryNode.geometry;l=null;if(this.buffers.has(c)){l=this.buffers.get(c);for(var v in c.attributes)c.attributes[v].version>l.vbos.get(v).version&&this.updateBuffer(a,c)}else l=this.createBuffer(a,c),this.buffers.set(c,l);a.bindVertexArray(l.vao);
a.drawArrays(a.POINTS,0,l.numElements)}a.bindVertexArray(null)}renderOctree(a,b,c,e){var d=a.getContext(),f=b.material,g=e.matrixWorldInverse,k=e.matrixWorld,h=e.projectionMatrix,l=(new THREE.Matrix4).getInverse(h);new THREE.Matrix4;var m=null,p=0;if(f.pointSizeType===Q.ADAPTIVE||f.pointColorType===A.LOD){m=b.computeVisibilityTextureData(c,e);var n=f.visibleNodesTexture;n.image.data.set(m.data);n.needsUpdate=!0}n=null;this.shaders.has(f)?n=this.shaders.get(f):(n=new Ga(d,'pointcloud',f.vertexShader,
f.fragmentShader),this.shaders.set(f,n));var q=['#define num_shadowmaps0','#define num_snapshots'+(f.snapEnabled?f.numSnapshots:0),'#define num_clipboxes'+(f.clipBoxes&&f.clipBoxes.length?f.clipBoxes.length:0),'#define num_clipspheres0','#define num_clippolygons'+(f.clipPolygons&&f.clipPolygons.length?f.clipPolygons.length:0)].join('\n');n.update(q+'\n'+f.vertexShader,q+'\n'+f.fragmentShader);f.needsUpdate=!1;for(var r of Object.keys(f.uniforms))if(q=f.uniforms[r],'t'==q.type&&(q=q.value)){if(!this.textures.has(q)){var t=
new ka(d,q);this.textures.set(q,t)}this.textures.get(q).update()}d.useProgram(n.program);1>f.opacity?(d.enable(d.BLEND),d.blendFunc(d.SRC_ALPHA,d.ONE),d.depthMask(!1),d.disable(d.DEPTH_TEST)):(d.disable(d.BLEND),d.depthMask(!0),d.enable(d.DEPTH_TEST));n.setUniformMatrix4('projectionMatrix',h);n.setUniformMatrix4('viewMatrix',g);n.setUniformMatrix4('uViewInv',k);n.setUniformMatrix4('uProjInv',l);q=f.screenHeight;n.setUniform1f('uScreenWidth',f.screenWidth);n.setUniform1f('uScreenHeight',q);n.setUniform1f('fov',
Math.PI*e.fov/180);n.setUniform1f('near',e.near);n.setUniform1f('far',e.far);a.capabilities.logarithmicDepthBuffer&&n.setUniform('logDepthBufFC',2/(Math.log(e.far+1)/Math.LN2));e instanceof THREE.OrthographicCamera?(n.setUniform('uUseOrthographicCamera',!0),n.setUniform('uOrthoWidth',e.right-e.left),n.setUniform('uOrthoHeight',e.top-e.bottom)):n.setUniform('uUseOrthographicCamera',!1);0===f.clipBoxes.length+f.clipPolygons.length?n.setUniform1i('clipTask',U.NONE):n.setUniform1i('clipTask',f.clipTask);
n.setUniform1i('clipMethod',f.clipMethod);f.clipBoxes&&0<f.clipBoxes.length&&d.uniformMatrix4fv(n.uniformLocations['clipBoxes[0]'],!1,f.uniforms.clipBoxes.value);n.setUniform1f('size',f.size);n.setUniform1f('maxSize',f.uniforms.maxSize.value);n.setUniform1f('minSize',f.uniforms.minSize.value);n.setUniform1f('uOctreeSpacing',f.spacing);n.setUniform('uOctreeSize',f.uniforms.octreeSize.value);n.setUniform3f('uColor',f.color.toArray());n.setUniform1f('uOpacity',f.opacity);n.setUniform2f('elevationRange',
f.elevationRange);n.setUniform2f('intensityRange',f.intensityRange);n.setUniform1f('intensityGamma',f.intensityGamma);n.setUniform1f('intensityContrast',f.intensityContrast);n.setUniform1f('intensityBrightness',f.intensityBrightness);n.setUniform1f('rgbGamma',f.rgbGamma);n.setUniform1f('rgbContrast',f.rgbContrast);n.setUniform1f('rgbBrightness',f.rgbBrightness);n.setUniform1f('uTransition',f.transition);n.setUniform1f('wRGB',f.weightRGB);n.setUniform1f('wIntensity',f.weightIntensity);n.setUniform1f('wElevation',
f.weightElevation);n.setUniform1f('wClassification',f.weightClassification);n.setUniform1f('wReturnNumber',f.weightReturnNumber);n.setUniform1f('wSourceID',f.weightSourceID);q=this.textures.get(f.visibleNodesTexture);n.setUniform1i('visibleNodesTexture',p);d.activeTexture(d.TEXTURE0+p);d.bindTexture(q.target,q.id);p++;q=this.textures.get(f.gradientTexture);n.setUniform1i('gradient',p);d.activeTexture(d.TEXTURE0+p);d.bindTexture(q.target,q.id);p++;q=this.textures.get(f.classificationTexture);n.setUniform1i('classificationLUT',
p);d.activeTexture(d.TEXTURE0+p);d.bindTexture(q.target,q.id);p++;if(!0===f.snapEnabled){q=n.uniformLocations['uSnapshot[0]'];h=n.uniformLocations['uSnapshotDepth[0]'];g=Array(5).fill(p).map((a,b)=>a+b);k=Array(5).fill(1+Math.max(...g)).map((a,b)=>a+b);p=1+Math.max(...k);d.uniform1iv(q,g);d.uniform1iv(h,k);for(p=0;5>p;p++){q=f.uniforms.uSnapshot.value[p];h=f.uniforms.uSnapshotDepth.value[p];if(!q)break;q=a.properties.get(q).__webglTexture;h=a.properties.get(h).__webglTexture;l=k[p];d.activeTexture(d[`TEXTURE${g[p]}`]);
d.bindTexture(d.TEXTURE_2D,q);d.activeTexture(d[`TEXTURE${l}`]);d.bindTexture(d.TEXTURE_2D,h)}p=[].concat(...f.uniforms.uSnapView.value.map(a=>a.elements));d.uniformMatrix4fv(n.uniformLocations['uSnapView[0]'],!1,p);p=[].concat(...f.uniforms.uSnapProj.value.map(a=>a.elements));d.uniformMatrix4fv(n.uniformLocations['uSnapProj[0]'],!1,p);p=[].concat(...f.uniforms.uSnapProjInv.value.map(a=>a.elements));d.uniformMatrix4fv(n.uniformLocations['uSnapProjInv[0]'],!1,p);p=[].concat(...f.uniforms.uSnapViewInv.value.map(a=>
a.elements));d.uniformMatrix4fv(n.uniformLocations['uSnapViewInv[0]'],!1,p)}this.renderNodes(a,b,c,m,e,n);d.activeTexture(d.TEXTURE2);d.bindTexture(d.TEXTURE_2D,null);d.activeTexture(d.TEXTURE0)}}r.AttributeLocations=Z;r.BasicGroup=Ia;r.BinaryHeap=fa;r.BinaryLoader=va;r.Classification=Ea;r.ClipMethod={INSIDE_ANY:0,INSIDE_ALL:1};r.ClipTask=U;r.DEM=sa;r.DEMNode=ha;r.EptBinaryLoader=ya;r.EptLaszipLoader=za;r.EptLoader=Ca;r.Global=u;r.Gradients=Da;r.GreyhoundBinaryLoader=ua;r.GreyhoundLoader=N;r.GreyhoundUtils=
H;r.Group=Sa;r.HelperUtils=L;r.LASLAZLoader=wa;r.LASLoader=R;r.LRU=pa;r.POCLoader=aa;r.PointAttribute=t;r.PointAttributeNames=x;r.PointAttributeTypes=C;r.PointAttributes=F;r.PointCloudArena4D=Fa;r.PointCloudArena4DGeometry=ja;r.PointCloudEptGeometry=Aa;r.PointCloudGreyhoundGeometry=ta;r.PointCloudMaterial=M;r.PointCloudOctree=da;r.PointCloudOctreeGeometry=xa;r.PointCloudTree=T;r.PointColorType=A;r.PointShape=Y;r.PointSizeType=Q;r.Points=Ra;r.Shader=Ga;r.Shaders=P;r.TreeType=X;r.VersionUtils=E;r.WebGLBuffer=
Ha;r.WebGLTexture=ka;r.WorkerManager=y;r.loadPointCloud=function(a,b,c){var e=function(a){void 0!==b&&(a.name=b);c({type:'pointcloud_loaded',pointcloud:a})};if(0===a.indexOf('greyhound://'))N.load(a,function(a){void 0!==a&&e(new da(a))});else if(0<a.indexOf('cloud.js'))aa.load(a,function(a){void 0!==a&&e(new da(a))});else if(0<a.indexOf('ept.json'))Ca.load(a,function(a){void 0!==a&&e(new da(a))});else if(0<a.indexOf('.vpc'))ja.load(a,function(a){void 0!==a&&e(new Fa(a))});else throw Error('Potree: Failed to load point cloud from URL '+
a);};r.updatePointClouds=oa;r.updateVisibility=ma;r.updateVisibilityStructures=na;Object.defineProperty(r,'__esModule',{value:!0})});
